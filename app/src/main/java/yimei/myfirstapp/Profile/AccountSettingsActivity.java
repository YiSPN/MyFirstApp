...
import yimei.myfirstapp.Utils.SectionsStatePagerAdapter;

/**
 * Created by yimei on 9/17/2017.
 */
...
public class AccountSettingsActivity extends AppCompatActivity {
    ...
    private void getIncomingIntent(){
        ...
        if(intent.hasExtra(getString(R.string.selected_image))
            ...
            //if there is an umageUrl attached as an extra, then it was chosen from the gallery/photo fragment.

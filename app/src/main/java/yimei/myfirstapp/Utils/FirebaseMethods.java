...
import yimei.myfirstapp.Profile.AccountSettingsActivity;
import yimei.myfirstapp.R;

/**
 * Created by yimei on 9/29/2017.
 */
        ...
        if(photoType.equals(mContext.getString(R.string.new_photo))){
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    //add the new photo to the 'photo' node and 'user_photos' node
...
//    }
     ...
     * Add information to the user_acount_settings node.
     * @param email
     * @param username
     * @param description
     * @param website
    ...
    public UserSettings getUserSettings(DataSnapshot dataSnapshot){
        Log.d(TAG, "getUserAccountSettings: retrieveing user account settings from firebase.");

        UserAccountSettings settings = new UserAccountSettings();
        User user = new User();

        for(DataSnapshot ds : dataSnapshot.getChildren()){
            //user_account settings node

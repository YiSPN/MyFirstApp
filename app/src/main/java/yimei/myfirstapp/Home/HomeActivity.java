...
import yimei.myfirstapp.Login.LoginActivity;
import yimei.myfirstapp.R;
import yimei.myfirstapp.Utils.BottomNavigationViewHelper;
import yimei.myfirstapp.Utils.SectionsPagerAdapter;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private void setupViewPager()
    {
        ...
        View view = getLayoutInflater().inflate(R.layout.image_custom_tab, null);
//        view.findViewById(R.id.ic_icon).setBackgroundResource(R.drawable.ic_instagram);
